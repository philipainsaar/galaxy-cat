...
function createFluffSpriteTexture() {
  ...
  gradient.addColorStop(0.0, 'rgba(255,255,255,0.62)');
  gradient.addColorStop(0.20, 'rgba(255,255,255,0.42)');
...
function collectFluffSurfaceSamples(root, skipPattern, maxSamplesPerMesh = 220) {
  const samples = [];
  ...
  (texture) => {
    ...
    renderer.setAnimationLoop(() => {
      ...
      fluffClouds.forEach((cloud) => {
        ...
        cloud.material.size = motion.baseSize * (0.98 + shimmer * 0.025);
        cloud.material.opacity = motion.baseOpacity * (0.94 + shimmer * 0.06);
      });
